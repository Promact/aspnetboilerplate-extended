...
using Shouldly;
using Xunit;
using AspnetBoilerplateExtended.Sessions;

namespace AspnetBoilerplateExtended.Tests.Sessions
{
    public class SessionAppService_Tests : AspnetBoilerplateExtendedTestBase
    {
