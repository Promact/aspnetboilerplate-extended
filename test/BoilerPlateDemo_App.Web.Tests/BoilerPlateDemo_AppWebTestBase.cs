...
{
    public abstract class BoilerPlateDemo_AppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerPlateDemo_AppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerPlateDemo_AppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerPlateDemo_AppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerPlateDemo_AppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerPlateDemo_AppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerPlateDemo_AppDbContext, Task<T>> func)
        {
            T result;
