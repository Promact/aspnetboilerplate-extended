...
{
    public abstract class AspnetBoilerplateExtendedWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspnetBoilerplateExtendedWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspnetBoilerplateExtendedWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspnetBoilerplateExtendedDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspnetBoilerplateExtendedDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspnetBoilerplateExtendedDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspnetBoilerplateExtendedDbContext, Task<T>> func)
        {
            T result;
