...
namespace BoilerPlateDemo_App.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BoilerPlateDemo_AppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(BoilerPlateDemo_AppDbContext context)
        {
            _context = context;
        }
