...
{
    [DbContext(typeof(BoilerPlateDemo_AppDbContext))]
    [Migration("20210118095158_Add Project master table")]
    partial class AddProjectmastertable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoilerPlateDemo_App.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BoilerPlateDemo_App.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BoilerPlateDemo_App.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BoilerPlateDemo_App.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BoilerPlateDemo_App.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BoilerPlateDemo_App.Authorization.Roles.Role", b =>
                {
                    b.HasOne("BoilerPlateDemo_App.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("BoilerPlateDemo_App.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("BoilerPlateDemo_App.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
