...
export class ApplicationServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, nameFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetApplicationForViewDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetApplicationForViewDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetApplicationForViewDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GetApplicationForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetApplicationForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetApplicationForViewDtoPagedResultDto>(<any>null);
    }
    ...
    getUsersToExcel(): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Application/GetUsersToExcel";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getApplication(id: number | undefined): Observable<GetApplicationForEditOutput> {
    ...
    protected processGetApplication(response: HttpResponseBase): Observable<GetApplicationForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetApplicationForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    updateApplication(body: CreateOrEditApplicationDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    createApplication(body: CreateOrEditApplicationDto | undefined): Observable<void> {
    ...
    protected processCreateApplication(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getApplicationForEdit(id: number | undefined): Observable<GetApplicationForEditOutput> {
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditApplicationDto | undefined): Observable<void> {
    ...
    getAllProjects(): Observable<Project[]> {
        let url_ = this.baseUrl + "/api/services/app/Application/GetAllProjects";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class UserUpdateDetailsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getUserDetails(id: string | null | undefined): Observable<UserUpdateDetailDto> {
        let url_ = this.baseUrl + "/api/services/app/UserUpdateDetails/GetUserDetails?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<UserUpdateDetailDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<UserUpdateDetailDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetUserDetails(response: HttpResponseBase): Observable<UserUpdateDetailDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserUpdateDetailDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<UserUpdateDetailDto>(<any>null);
    }
     ...
     * @return Success
     */
    updateUserDetails(body: UserUpdateDetailDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserUpdateDetails/UpdateUserDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateUserDetails(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateUserDetails(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateUserDetails(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class GetApplicationForViewDto implements IGetApplicationForViewDto {
    application: ApplicationDto;

    constructor(data?: IGetApplicationForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.application = _data["application"] ? ApplicationDto.fromJS(_data["application"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetApplicationForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetApplicationForViewDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetApplicationForViewDto {
        const json = this.toJSON();
        let result = new GetApplicationForViewDto();
        result.init(json);
        return result;
...
export interface IGetApplicationForViewDto {
    application: ApplicationDto;
}

export class GetApplicationForViewDtoPagedResultDto implements IGetApplicationForViewDtoPagedResultDto {
    totalCount: number;
    items: GetApplicationForViewDto[] | undefined;

    constructor(data?: IGetApplicationForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetApplicationForViewDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): GetApplicationForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetApplicationForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetApplicationForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetApplicationForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetApplicationForViewDtoPagedResultDto {
    totalCount: number;
    items: GetApplicationForViewDto[] | undefined;
}
...
export class CreateOrEditApplicationDto implements ICreateOrEditApplicationDto {
    ...
    clone(): CreateOrEditApplicationDto {
        const json = this.toJSON();
        let result = new CreateOrEditApplicationDto();
        result.init(json);
        return result;
...
export class GetApplicationForEditOutput implements IGetApplicationForEditOutput {
    applications: CreateOrEditApplicationDto;
    ...
    init(_data?: any) {
        if (_data) {
            this.applications = _data["applications"] ? CreateOrEditApplicationDto.fromJS(_data["applications"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["applications"] = this.applications ? this.applications.toJSON() : <any>undefined;
        return data; 
    }

    clone(): GetApplicationForEditOutput {
        const json = this.toJSON();
        let result = new GetApplicationForEditOutput();
        result.init(json);
        return result;
...
export class UserUpdateDetailDto implements IUserUpdateDetailDto {
    name: string;
    surname: string;
    userName: string;
    emailAddress: string;
    ...
    constructor(data?: IUserUpdateDetailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserUpdateDetailDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserUpdateDetailDto();
        result.init(data);
        return result;
    }
...
export interface IUserUpdateDetailDto {
    name: string;
    surname: string;
    userName: string;
    emailAddress: string;
